  ...
  <div id="evolife">
    ...
    <div id="control_panel">
      <div id="controls_wrapper">
        ...
        <label>Steps per second: </label><span id="steps_per_sec"/>

        <div id="speed_ctrl_container">
          <button type="button" class="ctrl_button" id="slower">
            Slower
          </button>
          <button type="button" class="ctrl_button" id="pause">
            Pause
          </button>
          <button type="button" class="ctrl_button" id="faster">
            Faster
          </button>
          <button type="button" class="ctrl_button" id="step" disabled>
            Step
          </button>
        </div>
